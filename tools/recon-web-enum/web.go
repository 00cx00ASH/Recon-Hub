...
var probePaths = []struct {
	...
	{"/web.config", "sensitive-file", "high"},
	{"/.aws/credentials", "sensitive-file", "high"},
	{"/.gcp/credentials.json", "sensitive-file", "high"},
	{"/.ssh/config", "sensitive-file", "medium"},
	{"/.ssh/id_rsa", "sensitive-file", "high"},
	{"/terraform.tfstate", "sensitive-file", "high"},
	{"/.terraform/terraform.tfstate", "sensitive-file", "high"},
	{"/wp-config.php.bak", "sensitive-file", "high"},
	{"/docker-compose.yml", "sensitive-file", "medium"},
	{"/id_rsa", "sensitive-file", "high"},
	{"/.npmrc", "sensitive-file", "medium"},
	{"/settings.py", "sensitive-file", "high"},
	{"/server-status", "debug", "medium"},
	{"/server-info", "debug", "medium"},
	{"/phpinfo.php", "debug", "high"},
	{"/info.php", "debug", "high"},
	{"/debug", "debug", "medium"},
	{"/debug/pprof/", "debug", "high"},
	{"/_debugbar/open", "debug", "high"},
	{"/_profiler/", "debug", "medium"},
	{"/actuator", "debug", "high"},
	{"/actuator/health", "debug", "low"},
	{"/actuator/env", "debug", "high"},
	{"/actuator/heapdump", "debug", "high"},
	{"/trace.axd", "debug", "medium"},
	{"/elmah.axd", "debug", "medium"},
	...
	{"/redoc", "api-doc", "low"},
	{"/.well-known/openid-configuration", "api-doc", "info"},
